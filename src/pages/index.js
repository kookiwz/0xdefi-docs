...
export const quickLinks = [
  {
    title: 'What is 0xDefi ?',
    href: '#',
    icon: InformationCircleIcon,
    to: './docs/intro',
    text: `Learn about the core concepts of the 0xDefi Protocol.`,
  },
  {
    title: 'Products',
    href: '#',
    icon: InformationCircleIcon,
    to: './docs/Products/0xDefi%20Swap/Liquidity%20Pools',
    text: `Learn about the products we are building on shardeum to onboard masses.`,
  },
  {
    title: 'Developers',
    href: '#',
    ...
    text: `Learn about the architecture of the 0xDefi smart contracts.`,
  }
];

export const Guides = [
  {
    title: 'AMM/Swap Quick Start',
    text: 'Learn how to interact with the 0xDefi AMM',
    to: './docs/Tutorials/How%20to%20Get%20Started%20on%200xDefi/How%20to%20Swap',
  },
  {
    title: 'Metamask Quick Start',
    text: 'Learn how to configure metamask wallet',
    to: './docs/Tutorials/How%20to%20Get%20Started%20on%200xDefi/Setting%20Up%20Your%20Wallet',
  },
];

export const github = [
  {
    title: '0xDefi-contracts',
    href: 'https://github.com/0xDefi',
    icon: CodeIcon,
  },
  {
    title: '0xDefi-UI',
...
export const faqs = [
  {
    title: 'General FAQs',
    href: './docs/FAQ/General%20FAQ',
    icon: QuestionMarkCircleIcon,
  },
  {
    title: 'Tokenomics FAQs',
    href: './docs/FAQ/Tokenomics%20FAQ',
    icon: QuestionMarkCircleIcon,
  },
    ...
    >
      ...
      <Container>
        <DocsHeader>
          ...
          >
            <h1 style={{ fontWeight: '700' }}> 0xDeFi Docs</h1>
          </div>
          <StyledTitleImage
            alt=""
            sources={{
              light: useBaseUrl('/img/bg.jpeg'),
              dark: useBaseUrl('/img/bg.jpeg'),
            }}
          />
          <Row>
            {quickLinks.map((link) => (
